...
//console.log(jsonData.page); //undefined
console.log(obj1.a);
console.log(jsonObj1);

const moviesData=JSON.parse(jsonData);
console.log(moviesData.results[0].adult);
const moviesData1=JSON.parse(jsonData);
console.log(httpPrefix+ moviesData1.results[0].poster_path);
console.log(httpPrefix+ moviesData1.results[0].backdrop_path);

console.log(httpPrefix+ moviesData1.results[1].poster_path);
console.log(httpPrefix+ moviesData1.results[1].backdrop_path);